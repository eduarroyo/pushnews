(function () {
    ...
    // Inicializar el mapa.
    tomtom.setProductInfo('PUSHNEWS', '4.47.6');
    var mapa = tomtom.L.map('mapa', {
        key: '9NVqGGbyKDflevuNaG9fQSbsb3mUP5Ao',
        center: [opciones.latitud, opciones.longitud],
        zoom: opciones.zoom,
    });
