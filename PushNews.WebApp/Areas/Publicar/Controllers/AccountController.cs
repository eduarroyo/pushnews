using PushNews.WebApp.Areas.Publicar.Models.Account;
...
namespace PushNews.WebApp.Areas.Publicar.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl = "/Publicar#/escritorio")
        {
        ...
        public async Task<ActionResult> RecuperarClave(RecuperarClaveModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string cuerpo = RenderToString("~/Areas/Publicar/Views/PlantillasEmail/RestablecerClave.cshtml", modeloEmail);
        ...
        public ActionResult ResetPassword(string code)
        {
            ...
            return View("~/Areas/Publicar/Views/Account/ResetPassword.cshtml");
        }
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            return View("~/Areas/Publicar/Views/Account/ResetPassword.cshtml", model);
        }
        ...
        {
            return View("~/Areas/Publicar/Views/Account/ResetPasswordConfirmation.cshtml");
        }
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Index", "PublicarHome");
        }
